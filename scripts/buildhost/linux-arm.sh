...
cat << EOF > exescript
git clone --depth=50 --branch ${BRANCH} https://github.com/vincentbdb/go-algorand go/src/github.com/vincentbdb/go-algorand
cd go/src/github.com/vincentbdb/go-algorand
